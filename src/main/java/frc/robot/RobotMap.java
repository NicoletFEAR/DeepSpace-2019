...
public class RobotMap {
    ...
    public static final double DRIVE_kP = 0.0005;
	...
	public static final double ARM_kP=.0005;
	...
	public static void init() {
		...
		frontLeft = new TalonSRX(16);
		midLeft = new TalonSRX(21);
		backLeft = new TalonSRX(22);
