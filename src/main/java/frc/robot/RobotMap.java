...
public class RobotMap {
    ...
    public static void init() {
        ...
        // these are on the left side looking from the side with the battery, they are numbered top down facing from the battery
        left1 = new TalonSRX(13);
        left2 = new TalonSRX(15);
        left3 = new TalonSRX(17);
        left4 = new TalonSRX(19);


        right1 = new TalonSRX(14);
        right2 = new TalonSRX(16);
        right3 = new TalonSRX(18);
		right4 = new TalonSRX(20);
